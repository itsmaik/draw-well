...
export default function CheckoutSuccess() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 px-10">
      <h1 className="text-3xl md:text-4xl font-bold mb-8">Order Successful!</h1>
